...
plt.tight_layout()
plt.savefig('examples/output/curve_paper.png', dpi=plt.rcParams['savefig.dpi'])
plt.show()

print("Paper preset グラフを保存しました: examples/output/curve_paper.png")
...
plt.tight_layout()
plt.savefig('examples/output/curve_presentation.png', 
            dpi=plt.rcParams['savefig.dpi'])
plt.show()

print("Presentation preset グラフを保存しました: examples/output/curve_presentation.png")
...
plt.tight_layout()
plt.savefig('examples/output/curve_presentation_large.png', 
            dpi=plt.rcParams['savefig.dpi'])
plt.show()

print("Presentation_large preset グラフを保存しました: examples/output/curve_presentation_large.png")
...
plt.tight_layout()
plt.savefig('examples/output/curve_complex.png', dpi=300)
plt.show()

print("複雑な曲線例を保存しました: examples/output/curve_complex.png") 